...
var noofparticles = 65000; //number of particles
var sizeofparticles = 30; //size of particle
...
sprite = THREE.ImageUtils.loadTexture( "https://threejs.org/examples/textures/sprite1.png" );
...
function random_rgba(h) {
    var o = Math.round, r = Math.random, s = 255;
    return 'rgba(' + o(h*s) + ',' + o(h*s) + ',' + o(h*s) + ',' + h.toFixed(1) + ')';
}
